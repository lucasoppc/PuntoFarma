...
<body>
    <form id="form1" runat="server">
        ...
        <div id="ingresoUsuario" class="auto-style6">
            <asp:TextBox ID="txtNumero" runat="server" Width="204px" Font-Size="Medium" ForeColor="#FF3300" Height="30px"></asp:TextBox>
        </div>
        <div id="boton" class="auto-style7">
            <asp:Button ID="Button1" runat="server" BackColor="#009933" BorderStyle="None" Font-Bold="True" Font-Size="Larger" ForeColor="White" Height="37px" Text="BUSCAR" Width="208px" OnClick="Button1_Click" />
        </div>
